...
<body>
    ...
    <main>
        <section id="meet">
            <h2 class="meet_title">初めての方へ</h2>
            <p class="meet_text">髪質改善サロンGRANT川崎店のホームページを<br>
                ご覧頂きありがとうございます。<br>
                <br>
                当店は髪を綺麗にしたいと思っている方のための特別なサロンです。<br>
                <br>
                さっそくなんですがこの様な髪のお悩みございませんか?<br>
                <br>
                ...
                オリジナルヘアエステメニューを体験してください。<br>
                <br>
                お客様にお伝えしたいことは正しいサロン施術と<br>
                正しいホームケアを継続することによって<br>
                どんな髪のお悩みがあっても必ず解決できて<br>
                <br>
                <span class="meet_bold">[艶のあるしなやかな美髪]</span><br>
                <br>
                になることができるということです。
            </p>
        </section>
        <section id="top_menu">
            <h2 class="top_menu_title">髪質改善ヘアエステストレート(縮毛矯正)</h2>
            <p class="top_menu_title_accesary">IMPROVEMENT</p>
            ...
            <h2 class="top_menu_title">髪質改善ヘアエステ</h2>
            <p class="top_menu_title_accesary">straightening</p>
            ...
            <h2 class="top_menu_title organic_title">オーガニックカラー</h2>
            <p class="top_menu_title_accesary">Organic</p>
            <div class="top_menu_imgs">
        ...
        <section id="recomend">
            <h2 class="top_title recomend_title">美容室GRANT川崎店「髪質改善ヘアエステ」<br>
                このような方におすすめです。
            </h2>
            <div class="hairs_img"><img src="<?php echo get_template_directory_uri(); ?>/images/hairs.png" alt="髪質改善ヘアエステの施術後ヘア"></div>
            <p class="recomend_caution">＊効果実感には個人差があり、<br class="sp-on">特定の効果を保証するものではありません</p>
            <p class="recomend_text">・普通のトリートメントでは満足できない<br><br class="sp-on">
                ...
                <br>
                縮毛矯正と一緒に、たっぷり栄養（活性ケラチン）を補給しながら髪の癖をとり、<br class="sp-off">しなやかで艶のあるストレートに仕上げます。<br>
                <br>
                ...
                <br>
                <span>お客様の髪の理解者として</span><br class="sp-off">髪の状態や骨格、髪の履歴などを正しく判断しご来店した日だけでなく、<br class="sp-off">次回ご来店頂くまで美髪を維持できるように髪質や<br class="sp-off">ライフスタイルに合わせたスタイリング方法をお伝えしています。<br>
                お客様のよき理解者としていつでもご相談ください。<br>
            </p>
        </section>
        <section id="flow">
            <h2 class="top_title">髪質改善エステの施術解説
            </h2>
            <p class="recomend_text">当店1番人気の[髪質改善ヘアエステカラー]を施術解説していきます。
            </p>
            <div>
                ...
                <p class="flow_text_1">今回のモデルさんの髪の状態は繰り返しのカラーリングや<br class="sp-off">
                    ...
                    (健康な髪の成分80%〜85%がタンパク質、<br class="sp-off">それ以外が脂質、水分、メラニン)それが髪のまとまりの悪さ、<br class="sp-off">
                    パサつき潤いのない髪の原因になります。
                </p>
                ...
                <p class="flow_text_1">髪の成分の構成比をみてもらえればいかに髪にとって<br class="sp-off">
                    ...
                    活性ケラチンという特別なタンパク質をしっかり補給することによって<br class="sp-off">髪を強化していきます。
                </p>
                <div>
                    <p class="flow_title">2・カウンセリング</p>
                    <p class="flow_text">お客様の髪質の現状やお悩みを、<br class="sp-off">カウンセリングシートを使用し細かく把握させてもらい、<br class="sp-off">髪質改善をするためにお客様1人ひとりにあっ髪た薬剤を選びます。</p>
                </div>
                <div>
                    <p class="flow_title">3・シャンプーと前処理
                    </p>
                    <p class="flow_text">最初にアルカリシャンプーで髪の表面に付いてる汚れや<br class="sp-off">シリコンを除去しつつこの後つけるタンパク質や処理剤の成分を<br class="sp-off">浸透しやすくする下準備をします。
                    </p>
                </div>
                <div>
                    <p class="flow_title">4・たっぷり栄養補給、カラーリング剤塗布</p>
                <div class="flow_graf"><img src="<?php echo get_template_directory_uri(); ?>/images/beauty_color.png" alt="健康な髪の構成成分"></div>
                    <p class="flow_text">まず活性ケラチンを塗布ししっかり内部補強してから<br class="sp-off">ご要望にそったカラーの薬剤を選定し塗布。<br>
                        カラー剤の中にも特別な髪質改善効果のある成分を<br class="sp-off">お客様の髪の状態にあわせて数種類入れさせてもらい<br class="sp-off">カラーリングしながら髪を補強し<br class="sp-off">艶のあるしなやかな髪にしていきます。<br>
                        リタッチカラーの場合は毛先に活性ケラチンで栄養補給し<br class="sp-off">髪質改善効果のある薬剤を浸透させます。</p>
                </div>
                <div>
                    <p class="flow_title">5・シャンプー、中間処理</p>
                    ...
                    <p class="flow_text">髪にとても優しいアミノ酸シャンプーを使用し<br>
                        ...
                        中間処理でもう一度活性ケラチン、髪質改善効果のある薬剤を補給し<br class="sp-off">痛みの元になる残留アルカリを除去します。<br>
                    </p>
                </div>
                <div>
                    <p class="flow_title">6・アフタートリートメント
                    </p>
                    <div class="flow_img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/treatment.png" alt="髪質改善ヘアエステのアフタートリートメント">
                    </div>
                    <p class="flow_text">カラーリングした後はアルカリ性に毛髪が傾いているので<br class="sp-off">健康な状態の弱酸性にph調整して毛髪の状態を整え<br class="sp-off">その後アフタートリートメントで毛髪に栄養と脂質！<br>
                        水分を補給し髪の質感を改善しツヤツヤの美髪にしていきます。<br>
                    </p>
                </div>
                <div>
                    <p class="flow_title">7・カット</p>
                    <p class="flow_text">ご要望いただいた内容をもとに<br class="sp-off">お客様のライフスタイルにあった髪が<br class="sp-off">最大限綺麗に見えるカットを提供したいと思っております。<br>
                    </p>
                </div>
                <div>
                    <p class="flow_title">8・仕上げ</p>
                    <p class="flow_text">最後ドライヤーで乾かしてアイロンで熱をいれ<br class="sp-off">髪の内部にいれた栄養や<br class="sp-off">艶のでる成分を定着させます。
                    </p>
                    <div class="flow_img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/final.png" alt="髪質改善ヘアエステの仕上げ">
                    </div>
                </div>
                <div>
                    <p class="flow_title">9・仕上がりのヘアースタイル
                    </p>
                    <div class="flow_img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/after.png" alt="髪質改善ヘアエステの仕上がりのヘアースタイル">
                    </div>
                    <p class="after_text">髪質改善されスタイリング時の収まりもよくなり<br class="sp-off">しなやかで艶のある髪に仕上がります。<br>
                        自分史上最高の艶髪と手触りを体感してください。<br>
                    </p>
                </div>
            </div>
            <p class="menu_text"><span class="menu_text_title">髪質改善ヘアエステメニュー</span><br>
                <br>
                <span style="font-weight: normal;">髪質改善ヘアエステ ¥11000<br>
                初回施術時間2時間<br>(シャンプー、ヘアエステ)<br>
                <br>
                ...
                (シャンプー、縮毛矯正、ヘアエステ)<br>
                <br>
                <span style="font-weight: bold; color: red;">＊当店はメニューロング料金はございません。</span><br><br>
        ...
        <section id="reserve">
            ...
            <p class="menu_text">神奈川県川崎市川崎区<br class="sp-on">小川町16-17MFプラザビル201<br>
                営業時間10時〜19時(カット最終受付)<br>
                定休日　火曜日<br>
                TEL044-211-1393</p>
        ...
        <section>
            ...
            <p class="top_menu_title_accesary news_title_accesary">NEWS</p>
                <?php
                    $args = array(
            ...
            <div class="news">
                <?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
                    <div class="news_item">
                        <a href="<?php the_permalink(); ?>" class="news_date"><?php echo the_time('Y.m.d'); ?></a><br>
                        <a href="<?php the_permalink(); ?>" class="news_text"><?php echo the_content(); ?></a>
                    </div>
                <?php endwhile; ?>
            </div>
                <?php endif; ?>
